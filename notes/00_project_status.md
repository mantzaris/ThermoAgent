...
- **Current phase:** The isolated RunPod setup, 143-test pretraining verification, and
...
- **Completed:** preservation/tag/branch; exact v1 holdout-tie diagnosis;
  ...
  143 passing tests; 8/8 v2 preflight replays; deterministic gzip/PDF artifact
