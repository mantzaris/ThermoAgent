...
Figure~\ref{fig:corrected-quench-series} displays the corrected time series from the earlier
...
Cluster-level recovery and delayed-audit material is retained in Appendix~\ref{app:study-inference}, including Figures~\ref{fig:cluster-recovery} and~\ref{fig:delayed-audit}.
...
distance is measured in the cluster-excluded nominal geometry.}{fig:corrected-quench-series}
...
Figure~\ref{fig:memory-controls} displays the paired cluster-level contrasts for the
...
the current trajectory.}{fig:memory-controls}
...
\ref{fig:cluster-recovery} retains every cluster-level recovery path, including the
...
historical recovery sign statistic is not used as directional evidence.}{fig:cluster-recovery}
...
Figure~\ref{fig:delayed-audit} records the delayed dependence and full-pipeline
permutation audit.
...
because of implementation omissions.}{fig:delayed-audit}
