...
names, and format.  Exact token equality is measured rather than assumed.
...
\end{equation}
within a prescribed rolling window.  We also estimate spatial correlation
along graph edges and integrated correlation time from the observable
magnetization sequence.  These are finite-trajectory quantities.
...
Matched arms share the same shuffle tape.
...
\resultfigure{figure02_memory_discovery_replication.pdf}{0.82\textwidth}{%
...
thermodynamic-limit analogy \cite{calabrese2006}.  The initial
...
\resultfigure{figure03_v14_quench_time_series.pdf}{0.84\textwidth}{%
...
\resultfigure{figure04_v14_cluster_recovery.pdf}{0.83\textwidth}{%
...
intervals.  Agent and time-point counts do not increase the inferential sample
size.
...
\resultfigure{figure06_cross_model_quench.pdf}{0.91\textwidth}{%
...
\resultfigure{figure07_v15_memory_controls.pdf}{0.80\textwidth}{%
...
schedule, and intervention times.

\resultfigure{figure10_direct_surrogate_quench.pdf}{0.92\textwidth}{%
...
\resultfigure{figure09_confirmatory_effects.pdf}{0.87\textwidth}{%
...
regenerated through content-addressed model decisions.  The complete V15
experiment used \csname V15GPUHours\endcsname{} measured generation GPU-hours.
No chain of
