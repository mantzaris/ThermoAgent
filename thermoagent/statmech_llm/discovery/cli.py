"""Command-line entry points for the discovery-stage workflow."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="ThermoAgent discovery-stage workflow")
    parser.add_argument(
        "command",
    ...
    if args.command == "pilot":
        ...
        engineering = repository / "configs/statmech_llm/discovery/engineering.yaml"
