...
from .simulation import build_reciprocal_graph, run_v13_trajectory
...
def _require_qwen_opt_in() -> None:
    if os.environ.get("THERMO_V13_ENABLE_QWEN") != "1":
...
def run_engineering_pilot(repository: Path) -> Dict[str, object]:
    ...
    configuration = load_yaml(repository / "configs/statmech_v13/engineering.yaml")
