...
from thermoagent.statmech_llm_v12.graphs import DeliveryGraph, build_delivery_graph
from thermoagent.statmech_llm_v12.simulation import (
...
@dataclass
class V13Agent(IndependentStatmechAgent):
...
def make_v13_agents(n_agents: int, seed: int, initial_condition: str) -> List[V13Agent]:
...
def run_v13_trajectory(
    ...
    agents = make_v13_agents(graph.n_agents, int(panel_seed), initial_condition)
