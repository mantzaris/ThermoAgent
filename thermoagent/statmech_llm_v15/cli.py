"""Command-line interface for the prospective V15 workflow."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="ThermoAgent V15 cross-model memory and quench study"
    )
    parser.add_argument(
        "command",
        choices=(
    ...
    if args.command == "pilot":
        ...
        from .surrogate import dense_surrogate_size_quench, v14_out_of_sample_quench_comparison

        result = {
            "v14_out_of_sample": v14_out_of_sample_quench_comparison(repository),
